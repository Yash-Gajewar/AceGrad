...
const CreatePost = () => {
    ...
    const handlePost = async () => {
        ...
        try {
            const response = await axios.post('http://localhost:8000/api/posts/createpost', postData, {
                headers: {
            ...
            <div className='CreateExperienceContainer'>
                <div className='FormContainer'>
                    ...
                    <form>
                        ...
                        {/* Post button */}
                        <button className="text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-l px-5 py-2.5 text-center me-2 mt-5 mr-5"
