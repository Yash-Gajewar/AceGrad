...
function Analytics() {
    ...
    return (
        ...
        <div className='flex bg-gray-100 w-full h-[725px]'>
            ...
            <div className='flex flex-col w-full h-full items-center'>
                ...
                <div className='flex flex-row'>
                    ...
                    <div className={`${collapsed ? 'hidden' : ''} min-w-[500px] ml-2 mr-2 transition-all duration-500 ease-in-out transform translate-x-0`} style={{ maxWidth: collapsed ? '0' : '100vw', overflow: 'hidden' }}>
